...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                # 配置了这个之后，就会把最底下的  MEDIA_URL STATIC_URL注册到 html ，这样 html 就能用 MEDIA_URL STATIC_URL 变量
...
EMAIL_PORT = 25
EMAIL_HOST_USER = '282495734'
EMAIL_HOST_PASSWORD = '1005360@lei'
EMAIL_USE_TLS = True
EMAIL_FROM = '282495734@qq.com'
